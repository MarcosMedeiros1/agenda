...
export const config: SheriffConfig = {
  autoTagging: false,
  entryPoints: {
    starter: "apps/starter/src/main.ts",
  },
  ...
  modules: {
    ...
    "libs/shared/model": ["domain:shared", "type:model"],
    "libs/shared/ui-<name>": ["domain:shared", "type:shared-ui"],
    "libs/shared/util-<name>": ["domain:shared", "type:util"],
  ...
  depRules: {
    ...
    "type:shared-ui": ["type:model", "type:util"],
